...
class GameEvent(UObject):
    def __init__(self, address = None, sdk=None):
        ...
        self.balls_offset = 0x08C0  # Updated
        self.cars_offset = 0x0350   # Unchanged
        self.pris_offset = 0x0340   # Unchanged
        self.teams_offset = 0x0910  # Updated
        self.players_offset = 0x0330  # Unchanged
    ...
    def get_game_time(self):
        return self.sdk.pm.read_int(self.address + 0x0814)  # Updated
    
    def get_warmup_time(self):
        return self.sdk.pm.read_int(self.address + 0x0818)  # Updated
    
    def get_max_score(self):
        return self.sdk.pm.read_int(self.address + 0x081C)  # Updated
    
    def get_time_remaining(self):
        return self.sdk.pm.read_float(self.address + 0x084C)  # Updated
        
    def get_seconds_remaining(self):
        return self.sdk.pm.read_int(self.address + 0x0850)  # Updated
    
    def get_total_game_time_played(self):
        return self.sdk.pm.read_float(self.address + 0x0858)  # Updated
    
    def get_overtime_played(self):
        return self.sdk.pm.read_float(self.address + 0x085C)  # Updated

    def is_round_active(self):
        return self.sdk.pm.read_int(self.address + 0x07F0) & 1  # Updated
    
    def is_play_replays(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 1) & 1  # Updated
    
    def is_ball_has_been_hit(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 2) & 1  # Updated
    
    def is_overtime(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 3) & 1  # Updated
    
    def is_unlimited_time(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 4) & 1  # Updated
    
    def is_no_contest(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 5) & 1  # Updated
    
    def is_disable_goal_delay(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 6) & 1  # Updated
    
    def is_show_no_scorer_goal_message(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 7) & 1  # Updated
    
    def is_match_ended(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 8) & 1  # Updated
    
    def is_show_intro_scene(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 9) & 1  # Updated
    
    def is_club_match(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 10) & 1  # Updated
    
    def is_can_drop_online_rewards(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 11) & 1  # Updated
    
    def is_allow_honor_duels(self):
        return (self.sdk.pm.read_int(self.address + 0x07F0) >> 12) & 1  # Updated
    
    def get_match_winner(self):
        team_address = self.sdk.pm.read_ulonglong(self.address + 0x0918)  # Updated
        return Team(team_address, sdk=self.sdk)
    
    def get_game_winner(self):
        team_address = self.sdk.pm.read_ulonglong(self.address + 0x0910)  # Updated
        return Team(team_address, sdk=self.sdk)
    
    def get_mvp(self):
        pri_address = self.sdk.pm.read_ulonglong(self.address + 0x0928)  # Updated
        return PRI(pri_address, sdk=self.sdk)
    
    def get_fastest_goal_player(self):
        pri_address = self.sdk.pm.read_ulonglong(self.address + 0x0930)  # Updated
        return PRI(pri_address, sdk=self.sdk)
    
    def get_slowest_goal_player(self):
        pri_address = self.sdk.pm.read_ulonglong(self.address + 0x0938)  # Updated
        return PRI(pri_address, sdk=self.sdk)
    
    def get_furthest_goal_player(self):
        pri_address = self.sdk.pm.read_ulonglong(self.address + 0x0940)  # Updated
        return PRI(pri_address, sdk=self.sdk)
    
    def get_fastest_goal_speed(self):
        return self.sdk.pm.read_float(self.address + 0x0948)  # Updated
    
    def get_slowest_goal_speed(self):
        return self.sdk.pm.read_float(self.address + 0x094C)  # Updated
    
    def get_furthest_goal(self):
        return self.sdk.pm.read_float(self.address + 0x0950)  # Updated
    
    def get_scoring_player(self):
        pri_address = self.sdk.pm.read_ulonglong(self.address + 0x0958)  # Updated
        return PRI(pri_address, sdk=self.sdk)
    
    def get_round_num(self):
        return self.sdk.pm.read_int(self.address + 0x0960)  # Updated
    
    def get_game_owner(self):
        pri_address = self.sdk.pm.read_ulonglong(self.address + 0x0430)  # Unchanged
        return PRI(pri_address, sdk=self.sdk)
    
    def get_count_down_time(self):
        return self.sdk.pm.read_int(self.address + 0x02A0)  # Unchanged

    def get_goals(self):
        goals_tarray_address = self.address + 0x08E0  # Updated
        return TArray(goals_tarray_address, Goal, sdk=self.sdk).get_items()

    def get_local_players(self):
        local_players_tarray_address = self.address + 0x0360  # Unchanged
...
class BoostComponent(Pointer):
    ...
    def get_amount(self):
        return self.sdk.pm.read_float(self.address + 0x0314)
    ...
    def get_start_amount(self):
        return self.sdk.pm.read_float(self.address + 0x0310)
